...
XrmSearch control allows to perform a XRM FetchXML search in AgileDialogs page
...
-   When a page control changes its value.

XrmSearch control does not create variables in process context.

![](../media/AgileDialogsDesignGuide/XRMSearchControl_01.png)

To configure XrmSearch control:
